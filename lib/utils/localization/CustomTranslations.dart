...
final class CustomTranslations extends Translations {
  @override
  Map<String, Map<String, String>> get keys => {
        'en_US': {
          ...
          CustomTranslationKeys.appVersionInformation: 'The current version of the application is %s. Please update.',
          ...
          // Another City
          CustomTranslationKeys.usePreciseLocation: 'Use precise location',
          ...
          //
          CustomTranslationKeys.noDateInformation: 'No Date Information',
          CustomTranslationKeys.noTimeInformation: 'No Time Information',
        },
        'tr_TR': {
          // Splash Slider
          ...
          // Remote Config
          CustomTranslationKeys.appVersion: 'app_version',
          CustomTranslationKeys.appVersionInformation: 'Uygulamanın mevcut sürümü %s. Lütfen güncelleyiniz.',
          ...
          // Another City
          CustomTranslationKeys.usePreciseLocation: 'Tam konumu kullan',
          ...
          //
          CustomTranslationKeys.noDateInformation: 'Tarih bilgisi yok',
          CustomTranslationKeys.noTimeInformation: 'Saat bilgisi yok',
        },
      };
